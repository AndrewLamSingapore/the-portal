...
for (const behavior of ['generateEncounter', 'maximizeSerendipity', 'renderCabinet', 'renderLenses', 'renderExperiments', 'renderEvolution', 'drawGraph', 'detailMarkup', 'playPortalTheme', 'togglePortalSound']) {
