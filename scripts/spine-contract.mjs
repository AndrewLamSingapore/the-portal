...
const env=(action)=>({tenant_id:'personal',actor_id:'owner',actor_type:'user',action,parameters:{},context:{},correlation_id:'c1',idempotency_key:`i-${action}`,schema_version:1,timestamp:new Date().toISOString()});
